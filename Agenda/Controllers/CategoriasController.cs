...
namespace Agenda.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,FechaCreacion")] Categorias categorias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,FechaCreacion")] Categorias categorias)
        {
            if (id != categorias.Id)
            {
                return NotFound();
